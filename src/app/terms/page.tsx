...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return locale === "en"
    ? {
        title: "Terms of use",
        description: "Terms for using TicketForge and its e-tickets.",
      }
    : {
        title: "Условия за ползване",
        description:
          "Условия за използване на TicketForge и електронните билети.",
      };
}
...
const TERMS_COPY = {
  bg: {
    ...
    scopeTitle: "1. Обхват",
    scope:
      "TicketForge предоставя каталог със събития, информация за наличност и възможност за издаване на електронни билети. С използването на услугата приемате настоящите условия.",
  ...
  en: {
    ...
    scopeTitle: "1. Scope",
    scope:
      "TicketForge provides an event catalogue, availability information and electronic ticket issuance. By using the service, you agree to these terms.",
